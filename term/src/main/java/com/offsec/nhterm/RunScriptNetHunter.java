...
public final class RunScriptNetHunter extends RemoteInterface {

    private static final String ACTION_RUN_SCRIPT_NH = "com.offsec.nhterm.RUN_SCRIPT_NH";
    ...
    protected void handleIntent() {
        ...
        if (action.equals(ACTION_RUN_SCRIPT_NH)) {
